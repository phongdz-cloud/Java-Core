...
public class Bai17 {
    /*
     * Viết chương trình kiểm tra các phần tử trong một mảng có gồm toàn các số hoàn
     * hảo không
     */
    static class Param {
        public int n;
    ...
    static void output(Boolean result) {
        if (result)
            System.out.println("Mang gom toan cac so hoan hao");
        else
            System.out.println("Mang khong gom toan cac so hoan hao");
    }
}
